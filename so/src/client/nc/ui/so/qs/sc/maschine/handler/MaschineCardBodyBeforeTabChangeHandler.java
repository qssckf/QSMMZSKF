...
/*    */   implements IAppEventHandler<CardBodyBeforeTabChangeEvent>
/*    */ {
/*    */   private AbstractUIAppModel model;
/*    */   private SaveAction saveAction;
/*    */   private CancelAction cancelAction;
/*    */   private PDWkEditAction editAction;
/*    */   
...
/* 44 */     if ((handler instanceof nc.ui.pd.pd0404.handler.tab_prodinv.PDWkCardBodyBeforeTabChangeHandler)) {
/* 45 */       ((nc.ui.pd.pd0404.handler.tab_prodinv.PDWkCardBodyBeforeTabChangeHandler)handler).setModel(getModel());
/*    */       
/* 47 */       ((nc.ui.pd.pd0404.handler.tab_prodinv.PDWkCardBodyBeforeTabChangeHandler)handler).setSaveAction(getSaveAction());
/*    */       
/* 49 */       ((nc.ui.pd.pd0404.handler.tab_prodinv.PDWkCardBodyBeforeTabChangeHandler)handler).setCancelAction(getCancelAction());
/*    */       
/* 51 */       ((nc.ui.pd.pd0404.handler.tab_prodinv.PDWkCardBodyBeforeTabChangeHandler)handler).setEditAction(getEditAction());
/*    */     }
/*    */     
/* 54 */     if (handler != null) {
...
/*    */   }
/*    */   
/*    */   public PDWkEditAction getEditAction() {
/* 87 */     return this.editAction;
/*    */   }
/*    */   
/*    */   public void setEditAction(PDWkEditAction editAction) {
