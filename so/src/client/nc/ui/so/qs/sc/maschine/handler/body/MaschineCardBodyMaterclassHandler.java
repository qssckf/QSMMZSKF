...
public class MaschineCardBodyMaterclassHandler extends MMBaseHandler{
	
	public MaschineCardBodyMaterclassHandler() {}
	...
	public void afterEdit(CardPanelEvent event){
		...
		for (int row : rows) {
			utils.setBodyValue(null, row, "pk_material", tabCode);
		}
	}
}