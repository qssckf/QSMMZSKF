package nc.ui.so.qs.sc.maschine.actions.process;
/*     */ 
...
/*     */   
/*  23 */   public void processVOAfterCopy(AggMaschineVO billVO, LoginContext context) { String pk_org_v = OrgUnitPubService.getNewVIDByOrgID(((MaschineVO)billVO.getParentVO()).getPk_org());
/*     */     
...
/*     */   {
/*  40 */     headVO.setAttributeValue("cpdwkid", null);
...
/*  61 */       machineMater_MaterItem.setAttributeValue("cpdwkid", null);
/*  62 */       machineMater_MaterItem.setAttributeValue("cwk_substid", null);
...
/*  75 */       machineCustomerItem.setAttributeValue("cpdwkid", null);
/*  76 */       machineCustomerItem.setAttributeValue("cwk_wipid", null);
...
/*  89 */       machineDeptItem.setAttributeValue("cpdwkid", null);
/*  90 */       machineDeptItem.setAttributeValue("cwk_wipid", null);
