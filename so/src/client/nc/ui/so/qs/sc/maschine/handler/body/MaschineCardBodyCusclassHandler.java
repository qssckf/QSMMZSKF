...
public class MaschineCardBodyCusclassHandler extends MMBaseHandler{
	
	public MaschineCardBodyCusclassHandler() {}
	...
	public void afterEdit(CardPanelEvent event){
		...
		for (int row : rows) {
			utils.setBodyValue(null, row, "pk_customer", tabCode);
		}
	}
}