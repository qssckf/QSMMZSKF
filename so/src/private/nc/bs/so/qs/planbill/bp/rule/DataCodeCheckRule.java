...
public class DataCodeCheckRule implements IRule{
	...
	public DataCodeCheckRule() {}
	
	public DataCodeCheckRule(String cbilltype, String codeItem, String groupItem, String orgItem)
	{
		this.cbilltype = cbilltype;
		this.codeItem = codeItem;
		this.groupItem = groupItem;
