...
import nc.bs.so.qs.sc.maschine.bp.rule.BillSetUnenableValueRule;
...
public class MaschineUnenableBP {
	
	public MaschineUnenableBP(){
		
	}
	
	public AggMaschineVO[] unenable(AggMaschineVO[] bills,AggMaschineVO[] oldbills) {
		// 调用修改模板
