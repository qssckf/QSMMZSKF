...
public class MaschineAddAfterEventRule
  implements IRule<AggMaschineVO>
{
  public MaschineAddAfterEventRule() {}
  
  public void process(AggMaschineVO[] vos)
  {
    BusinessEvent afterEvent = new BusinessEvent("c86a967d-98e0-49a9-8150-e8dc0158a5cd", "1002", vos);
    try
    {
